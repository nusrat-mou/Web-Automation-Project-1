...
public class RokomariHomePage extends BasePage {
	...
	public By Bottom_Scroll = By.xpath("//img[@alt='Himur Moddhodupur image']");
	public By Next_Page = By.xpath("//a[normalize-space()='Next']");
	public By Scroll2 = By.xpath("//p[contains(text(),'Ratings')]");
	public By Hover_Add_To_Cart = By.xpath("//h4[contains(text(),'মিসির আলি অমনিবাস-২')]");
	public By Add_To_Cart = By.xpath("//body[1]/div[5]/div[1]/div[1]/div[1]/section[2]/div[2]/div[1]/div[18]/div[1]/a[1]/div[1]/div[1]/button[1]");
